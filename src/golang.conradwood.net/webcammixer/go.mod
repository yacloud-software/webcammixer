...
require (
	...
	golang.conradwood.net/apis/images v1.1.2147
...
require (
	...
	golang.conradwood.net/apis/goeasyops v1.1.2147 // indirect
	golang.conradwood.net/apis/h2gproxy v1.1.2147 // indirect
